...
export const testimonialsData: Testimonial[] = [
  ...
  },
  {
    ...
    age: 62,
    location: 'Malad Outreach Clinic',
    treatment: 'Arthritis & Mobility Management',
    doctorName: 'Dr. Hardik Desai',
    rating: 5,
    comment: 'Having access to top-tier orthopedic surgeons directly at the Malad Outreach Clinic is a blessing for local residents. Systematic diagnosis, proper guidance on joint preservation, and zero unnecessary medications.',
    date: 'Verified Patient',
    verified: true
  }
];
