...
export const Terms: React.FC = () => {
  return (
    <>
      <SEOHead title="Terms & Conditions | SOS Speciality Orthopedic Service" />
      <div className="container container-narrow" style={{ padding: '4rem 1.5rem', lineHeight: 1.7 }}>
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem' }}>
          Welcome to <strong>SOS Speciality Orthopedic Service</strong>. By accessing our website or booking services (including Home X-Ray and OPD consultations), you agree to comply with the following terms.
        </p>
